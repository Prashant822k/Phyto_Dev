            ...
            onSubmit={async (e) => {
              ...
              try {
                ...
                const { error } = await supabase.auth.signUp({
                  ...
                  password,
                  options: {
                    emailRedirectTo: `${window.location.origin}/login-client`,
                    data: {
                ...
                toast({ title: "Verify your email", description: `We sent a verification link to ${email}. Click it to complete signup, then sign in.` });
